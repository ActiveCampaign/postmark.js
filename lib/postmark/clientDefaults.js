...
var ClientDefaults = {
  /**
   * The host name for whichever server we should use to access
   * the Postmark API.
   *
   * @default api.postmarkapp.com
   * @memberOf ClientDefaults
   * @instance
   */
  requestHost: "api.postmarkapp.com",
  /**
   * Should ssl be used for accessing the API (http/https)?
   * @default true
   * @memberOf ClientDefaults
   * @instance
   */
  ssl: true,
  /**
   * Given the set of options, produce a new function
   * that will be responsible for creating and processing
   * HTTP requests.
   * @memberOf ClientDefaults
