 ...
 * @param {number} id The ID for the Domain for which you wish to have the DKIM verified.
 * @param {PostmarkCallback} callback A standard callback that is called when the API request completes.
 * @return {Promise} If no callback is passed, returns a Promise with the JSON response from the API (or error).
 */
AdminClient.prototype.verifyDomainDKIM = function(id, callback) {
    return this.processRequestWithBody('/domains/' + id + '/verifydkim', 'PUT', null, callback);
};
 ...
 * @param {number} id The ID for the Domain for which you wish to have the Return Path verified.
 * @param {PostmarkCallback} callback A standard callback that is called when the API request completes.
 * @return {Promise} If no callback is passed, returns a Promise with the JSON response from the API (or error).
 */
AdminClient.prototype.verifyDomainReturnPath = function(id, callback) {
    return this.processRequestWithBody('/domains/' + id + '/verifyreturnpath', 'PUT', null, callback);
};
