...
(function () {
     ...
     * @param {number} id The ID of the Outbound Message for which you wish to retrieve a dump.
     * @param {PostmarkCallback} callback A standard callback that is called when the API request completes.
     * @return {Promise} If no callback is passed, returns a Promise with the JSON response from the API (or error).
     */
    Client.prototype.getOutboundMessageDump = function(id, callback) {
        return this.processRequestWithoutBody('/messages/outbound/' + id + '/dump', 'GET', null, callback);
    };
     ...
     * @return {Promise} If no callback is passed, returns a Promise with the JSON response from the API (or error).
     */
    Client.prototype.getOutboundOverview = function(filter, callback) {
        callback = coalesceCallback(filter, callback);
