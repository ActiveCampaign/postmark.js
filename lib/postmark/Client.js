(function() {
    ...
    Client.prototype.sendWithTemplate = function(message, callback) {
        this.processRequestWithoutBody('/email/withTemplate', 'POST', message, callback);
    };
    ...
    Client.prototype.getTemplates = function(options, callback) {
        ...
        this.processRequestWithBody('/templates', 'GET', options, callback);
    };


    Client.prototype.getTemplate = function(id, callback) {
        this.processRequestWithBody('/templates' + id, 'GET', null, callback);
    };
    ...
    Client.prototype.createTemplate = function(template, callback) {
        this.processRequestWithoutBody('/templates/', 'POST', template, callback);
    }

    Client.prototype.editTemplate = function(template, callback) {
        this.processRequestWithoutBody('/templates/', 'PUT', template, callback);
    }

    Client.prototype.validateTemplate = function(templateContent, callback) {
        this.processRequestWithoutBody('/templates/', 'POST', templateContent, callback);
    }
