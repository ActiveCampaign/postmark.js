...
var ServerClient = /** @class */ (function (_super) {
    ...
    */
    ServerClient.prototype.sendEmail = function (message, callback) {
        return this.processRequestWithBody('/email', models_1.HttpMethod.POST, message, callback);
    };
    /**
    ...
    ServerClient.prototype.sendEmailWithTemplate = function (message, callback) {
        return this.processRequestWithBody('/email/withTemplate', models_1.HttpMethod.POST, message, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.sendEmailBatchWithTemplates = function (messages, callback) {
        return this.processRequestWithBody('/email/batchWithTemplates', models_1.HttpMethod.POST, { Messages: messages }, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.sendEmailBatch = function (messages, callback) {
        return this.processRequestWithBody('/email/batch', models_1.HttpMethod.POST, messages, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getDeliveryStatistics = function (callback) {
        return this.processRequestWithoutBody('/deliverystats', models_1.HttpMethod.GET, null, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getBounces = function (filter, callback) {
        ...
        return this.processRequestWithoutBody('/bounces', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getBounce = function (id, callback) {
        return this.processRequestWithoutBody("/bounces/" + id, models_1.HttpMethod.GET, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getBounceDump = function (id, callback) {
        return this.processRequestWithoutBody("/bounces/" + id + "/dump", models_1.HttpMethod.GET, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.activateBounce = function (id, callback) {
        return this.processRequestWithBody("/bounces/" + id + "/activate", models_1.HttpMethod.PUT, null, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getBounceTags = function (callback) {
        return this.processRequestWithoutBody('/bounces/tags', models_1.HttpMethod.GET, null, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getServer = function (callback) {
        return this.processRequestWithoutBody('/server', models_1.HttpMethod.GET, null);
    };
    ;
    /**
    ...
    ServerClient.prototype.editServer = function (serverOptions, callback) {
        return this.processRequestWithBody('/server', models_1.HttpMethod.PUT, serverOptions, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getOutboundMessages = function (filter, callback) {
        ...
        return this.processRequestWithoutBody('/messages/outbound', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getOutboundMessageDetails = function (id, callback) {
        return this.processRequestWithoutBody("/messages/outbound/" + id + "/details", models_1.HttpMethod.GET, null, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getMessageOpens = function (filter, callback) {
        ...
        return this.processRequestWithoutBody('/messages/outbound/opens', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getMessageClicks = function (filter, callback) {
        ...
        return this.processRequestWithoutBody('/messages/outbound/clicks', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getMessageClicksForSingleMessage = function (messageId, filter, callback) {
        ...
        return this.processRequestWithoutBody("/messages/outbound/clicks/" + messageId, models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getMessageOpensForSingleMessage = function (messageId, filter, callback) {
        ...
        return this.processRequestWithoutBody("/messages/outbound/opens/" + messageId, models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getInboundMessages = function (filter, callback) {
        ...
        return this.processRequestWithoutBody('/messages/inbound', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getInboundMessageDetails = function (messageId, callback) {
        return this.processRequestWithoutBody("/messages/inbound/" + messageId + "/details", models_1.HttpMethod.GET, null, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.bypassBlockedInboundMessage = function (messageId, callback) {
        return this.processRequestWithoutBody("/messages/inbound/" + messageId + "/bypass", models_1.HttpMethod.PUT, null, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.retryInboundHookForMessage = function (messageId, callback) {
        return this.processRequestWithoutBody("/messages/inbound/" + messageId + "/retry", models_1.HttpMethod.PUT, null, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getOuboundOverview = function (filter, callback) {
        return this.processRequestWithoutBody('/stats/outbound', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getSentCounts = function (filter, callback) {
        return this.processRequestWithoutBody('/stats/outbound/sends', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getBounceCounts = function (filter, callback) {
        return this.processRequestWithoutBody('/stats/outbound/bounces', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getSpamComplaints = function (filter, callback) {
        return this.processRequestWithoutBody('/stats/outbound/spam', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getTrackedEmailCounts = function (filter, callback) {
        return this.processRequestWithoutBody('/stats/outbound/tracked', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getEmailOpenCounts = function (filter, callback) {
        return this.processRequestWithoutBody('/stats/outbound/opens', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getEmailPlatformUsage = function (filter, callback) {
        return this.processRequestWithoutBody('/stats/outbound/opens/platforms', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getEmailClientUsage = function (filter, callback) {
        return this.processRequestWithoutBody('/stats/outbound/opens/emailclients', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getEmailReadTimes = function (filter, callback) {
        return this.processRequestWithoutBody('/stats/outbound/opens/readtimes', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getClickCounts = function (filter, callback) {
        return this.processRequestWithoutBody('/stats/outbound/clicks', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getBrowserUsage = function (filter, callback) {
        return this.processRequestWithoutBody('/stats/outbound/clicks/browserfamilies', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getBrowserPlatforms = function (filter, callback) {
        return this.processRequestWithoutBody('/stats/outbound/clicks/platforms', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getClickLocation = function (filter, callback) {
        return this.processRequestWithoutBody('/stats/outbound/clicks/location', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.createTagTrigger = function (options, callback) {
        return this.processRequestWithBody('/triggers/tags', models_1.HttpMethod.POST, options, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.editTagTrigger = function (id, options, callback) {
        return this.processRequestWithBody('/triggers/tags/' + id, models_1.HttpMethod.PUT, options, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.deleteTagTrigger = function (id, callback) {
        return this.processRequestWithoutBody("/triggers/tags/" + id, models_1.HttpMethod.DELETE, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getTagTrigger = function (id, callback) {
        return this.processRequestWithoutBody("/triggers/tags/" + id, models_1.HttpMethod.GET, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getTagTriggers = function (filter, callback) {
        ...
        return this.processRequestWithoutBody('/triggers/tags/', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.createInboundRuleTrigger = function (options, callback) {
        return this.processRequestWithBody('/triggers/inboundrules', models_1.HttpMethod.POST, options, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.deleteInboundRuleTrigger = function (id, callback) {
        return this.processRequestWithoutBody("/triggers/inboundrules/" + id, models_1.HttpMethod.DELETE, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getInboundRuleTriggers = function (filter, callback) {
        ...
        return this.processRequestWithoutBody('/triggers/inboundrules', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getTemplates = function (filter, callback) {
        ...
        return this.processRequestWithoutBody('/templates', models_1.HttpMethod.GET, filter, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.getTemplate = function (idOrAlias, callback) {
        return this.processRequestWithoutBody("/templates/" + idOrAlias, models_1.HttpMethod.GET, null, callback);
    };
    ;
    /**
    ...
    ServerClient.prototype.deleteTemplate = function (idOrAlias, callback) {
        return this.processRequestWithoutBody("/templates/" + idOrAlias, models_1.HttpMethod.DELETE, null, callback);
    };
    /**
    ...
    ServerClient.prototype.createTemplate = function (template, callback) {
        return this.processRequestWithBody('/templates/', models_1.HttpMethod.POST, template, callback);
    };
    /**
    ...
    ServerClient.prototype.editTemplate = function (idOrAlias, template, callback) {
        return this.processRequestWithBody("/templates/" + idOrAlias, models_1.HttpMethod.PUT, template, callback);
    };
    /**
    ...
    ServerClient.prototype.validateTemplate = function (templateContent, callback) {
        return this.processRequestWithBody('/templates/validate', models_1.HttpMethod.POST, templateContent, callback);
    };
    return ServerClient;
